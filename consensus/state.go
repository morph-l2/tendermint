...
func (cs *State) signVote(
	...
	batchSizeWithProposalBlock := len(zkConfigContext) + tsxSize(rawBatchTxs) + len(cs.ProposalBlock.Data.ZkConfig) + tsxSize(cs.proposalBlockRawTxs()) + len(cs.ProposalBlock.Data.Root)
	if cs.isBatchPoint(
		batchStartHeight,
