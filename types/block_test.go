...
func TestBlockAddEvidence(t *testing.T) {
	...
	block := MakeBlock(h, txs, nil, nil, commit, evList) // TODO
...
func TestBlockHash(t *testing.T) {
	...
	assert.Nil(t, MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, nil, nil).Hash()) // TODO
}
...
func TestBlockMakePartSet(t *testing.T) {
	...
	partSet, err := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, nil, nil).MakePartSet(1024) // TODO
	require.NoError(t, err)
...
func TestBlockMakePartSetWithEvidence(t *testing.T) {
	...
	partSet, err := MakeBlock(h, []Tx{Tx("Hello World")}, nil, nil, commit, evList).MakePartSet(512) // TODO
	require.NoError(t, err)
...
func TestBlockHashesTo(t *testing.T) {
	...
	block := MakeBlock(h, []Tx{Tx("Hello World")}, nil, nil, commit, evList) // TODO
...
func TestBlockSize(t *testing.T) {
	size := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, nil, nil).Size() // TODO
	if size <= 0 {
...
func TestBlockString(t *testing.T) {
	...
	block := MakeBlock(int64(3), []Tx{Tx("Hello World")}, nil, nil, nil, nil) // TODO
...
func TestBlockProtoBuf(t *testing.T) {
	...
	b1 := MakeBlock(h, []Tx{Tx([]byte{1})}, nil, nil, &Commit{Signatures: []CommitSig{}}, []Evidence{}) // TODO
	b1.ProposerAddress = tmrand.Bytes(crypto.AddressSize)

	b2 := MakeBlock(h, []Tx{Tx([]byte{1})}, nil, nil, c1, []Evidence{}) // TODO
	...
	b3 := MakeBlock(h, []Tx{}, nil, nil, c1, []Evidence{}) // TODO
