...
type BlockID struct {
	...
	PartSetHeader PartSetHeader `protobuf:"bytes,3,opt,name=part_set_header,json=partSetHeader,proto3" json:"part_set_header"`
}
...
func (m *BlockID) GetBatchHash() []byte {
	if m != nil {
		return m.BatchHash
	}
	return nil
...
type Header struct {
	...
	// batch info
	BatchHash []byte `protobuf:"bytes,15,opt,name=batch_hash,json=batchHash,proto3" json:"batch_hash,omitempty"`
}
...
func (m *Header) GetBatchHash() []byte {
	if m != nil {
		return m.BatchHash
	}
	return nil
...
type Data struct {
	...
	L2BlockMeta   []byte   `protobuf:"bytes,2,opt,name=l2_block_meta,json=l2BlockMeta,proto3" json:"l2_block_meta,omitempty"`
	L2BatchHeader []byte   `protobuf:"bytes,3,opt,name=l2_batch_header,json=l2BatchHeader,proto3" json:"l2_batch_header,omitempty"`
}
...
func (m *Data) GetL2BlockMeta() []byte {
	if m != nil {
		return m.L2BlockMeta
	}
	return nil
}

func (m *Data) GetL2BatchHeader() []byte {
	if m != nil {
		return m.L2BatchHeader
	}
	return nil
}
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *BlockID) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BatchHash) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.BatchHash)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Hash) > 0 {
...
func (m *Data) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.L2BatchHeader) > 0 {
		i -= len(m.L2BatchHeader)
		copy(dAtA[i:], m.L2BatchHeader)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.L2BatchHeader)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.L2BlockMeta) > 0 {
		i -= len(m.L2BlockMeta)
		copy(dAtA[i:], m.L2BlockMeta)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.L2BlockMeta)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Txs) > 0 {
...
func (m *Data) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field L2BlockMeta", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.L2BlockMeta = append(m.L2BlockMeta[:0], dAtA[iNdEx:postIndex]...)
			if m.L2BlockMeta == nil {
				m.L2BlockMeta = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field L2BatchHeader", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.L2BatchHeader = append(m.L2BatchHeader[:0], dAtA[iNdEx:postIndex]...)
			if m.L2BatchHeader == nil {
				m.L2BatchHeader = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
